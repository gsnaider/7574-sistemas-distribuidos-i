...
A su vez, el servidor backend tiene una API REST para las distintas operaciones de negocio, y el servidor frontend consume dicha API para conectarse con el servidor backend. La API REST del servidor backend está implementada usando JAX-RS.
